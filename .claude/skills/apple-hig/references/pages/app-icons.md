...
![An image of the Settings icon for watchOS. The visionOS and watchOS icon grid is overlaid on the icon to show how the icon's shape and its elements map to the grid.](/images/com.apple.HIG/app-icons-settings-app-grid-circle@2x.png)
