...
![A graphic that shows gameplay with a virtual control to move the character that's more visible while the character is moving.](/images/com.apple.HIG/game-controls-thumbstick-in-motion@2x.png)

**Hidden control**

![A graphic that shows gameplay with a virtual control to move the character that's less visible while the character is at rest.](/images/com.apple.HIG/game-controls-thumbstick-at-rest@2x.png)
