...
[`channels/web.md`](../channels/web.md). `relationship-note`, `offline-touch`,
`contact-preference` and `correction` are People's own told records, resolving to
[`told.md`](../told/people-told.md): the human-known facts (a hidden role, a conference meeting, a stated channel
