...
widgets: []
sure: "sure"
sure_because: "He is on Nadia's conference list with his own words on it, and the list says you may say where you got them."
when:
  mode: fresh
  words: "Eighteen days since the stand. Two more weeks and he will not remember the conversation."
watch:
  - for: "Ian's reply"
    next: "If he answers I'll treat 2021 as history rather than as a relationship, and start his rhythm again from today."
reply:
  module: buttons
actions:
  - label: "Send the Note"
    ...
    opens: draft
  - label: "Not Now"
    says: "Okay. I'll raise him again next week and then let the conference list go cold."
  - label: "Not Relevant"
    opens: reasons
reasons:
  - label: "Already Written"
    says: "Noted. I'll mark him worked and stop raising the list entry."
  - label: "Owen Has The List"
    says: "Understood. I'll treat the conference names as his and only raise the ones you met yourself."
  - label: "Not a Target"
    says: "Understood. I'll take Vanbrugh off the board and not raise it again unless you put it back."
draft:
  title: "Draft"
  hand: "Send"
  sub: "in your voice · sends only when you say"
  footer: "Says where you got him, because the list cleared it. His words, not your pitch."
phone:
  when: "Today"
  act: "Send Note"
  act_does: send
  view: "View Draft"
  subject: "Rebuilding the programme"
  said: "Sent. Five years, picked up."
  done: "Sent to Ian"
  done_text: "I've marked him worked off Nadia's list. If he answers I'll start his rhythm again from today rather than from 2021."
---

# Write to Ian Faulds about the thing he said at the stand

He came past on 3 September and said Vanbrugh is rebuilding its safety programme. You last spoke to him in 2021, when there was no need.
...
- lead-list · Nadia's safety conference list, 3 September, and his entry: the programme is being rebuilt.
- lead-list · The list says you may say where the names came from.
- gmail · Your thread with Ian in 2021. Four messages, last on 9 March 2021.
- linkedin · Ian Faulds, Group Safety Manager at Vanbrugh Mining, in post since 2019.
...
You came past our stand at the conference on the 3rd and said you were rebuilding the safety programme. I did not want to let that go without a note.

We spoke back in 2021, when there was nothing you needed, so I am not going to pretend this is a follow-up. It is a new conversation about a new thing.

What is driving the rebuild, and what is the bit of it you are least sure about?
