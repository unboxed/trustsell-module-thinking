...
`pricing-authority` resolves to [`told.md`](../told.md), the organisation's own told source.
`file-content` resolves to [`channels/drive.md`](../../01-integrations/channels/drive.md), the pricing
